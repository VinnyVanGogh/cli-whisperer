...
- =ç **Email**: [133192356+VinnyVanGogh@users.noreply.github.com]
- = **Issues**: [GitHub Issues](https://github.com/VinnyVanGogh/cli-whisperer/issues)
- =Ö **Documentation**: [Project Wiki](https://github.com/VinnyVanGogh/cli-whisperer/wiki)
